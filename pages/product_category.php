<?php
    ...
    if($category_id ==0)
        $sql = "SELECT tbl_product.product_id, tbl_product.product_image, tbl_product.product_name, tbl_product.product_price, tbl_product.product_price_pre, (100-round((tbl_product.product_price / tbl_product.product_price_pre)*100,0)) as 'product_discount' 
                ...
                LIMIT $index , 12
                ";
    else    $sql = "SELECT tbl_product.product_id, tbl_product.product_image, tbl_product.product_quantity, tbl_product.product_name, tbl_product.product_price, tbl_product.product_price_pre, (100-round((tbl_product.product_price / tbl_product.product_price_pre)*100,0)) as 'product_discount' 
            FROM tbl_product
            where category_id = $category_id 
            LIMIT $index , 12
            ";
                            ...
                            <div class="product-block col-4">
                                <div class="product__img-block">
                                    <div class="product__sale">
                                        <span class="sale-lable">- ' . $product_list[$i]['product_discount'] . '%</span>
                                    </div>
                                    <div class="product__sold-out-label"'; 
                                    if($product_list[$i]['product_quantity']>0) echo 'style="display: none;"'; 
                                    echo'>HẾT HÀNG</div>
                                    <div class="img">
                                        <a href="productdetail.php?id='.$product_list[$i]['product_id'].'" class="product__img-link">
                                            <img src="../img/product/'.$product_list[$i]['product_image'].'" alt="" class="product__img">
                                        </a>
                                        <div class="pdt_icon">
                                            <a class="btn-quickview" href="./productdetail.php?id='.$product_list[$i]['product_id'].'" data-handle="/products/monster-8-2" title="Xem nhanh">
                                                <i class="icon_list">
                                            ...
                                            <a href="./cart.php?id='.$product_list[$i]['product_id'].'" class="btn-buynow" data-max="1000" data-id="1087486242" data-variant="1087486242" title=" Mua ngay ">
                                                <i class="icon_list">
                                                    <?xml version="1.0" encoding="iso-8859-1"?>
                                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            ...
                                            <a class="btn-add-to-cart ajax_add_to_cart " data-max="1000" data-id="1087486242" data-variant="1087486242" href="./cart.php?id='.$product_list[$i]['product_id'].'" title="Thêm vào giỏ ">
                                                <i class="icon_list">
                                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                ...
                                <div class="product__detail">
                                    <a href="productdetail.php?id='.$product_list[$i]['product_id'].'" class="product__name" title="'.$product_list[$i]['product_name'].'">'.$product_list[$i]['product_name'].'</a>
                                    <div class="product__price">
                                        <p class="pro-price__new">'.number_format($product_list[$i]['product_price']).'đ</p>
                                        <p class="pro-price__old">'.number_format($product_list[$i]['product_price_pre']).'đ</p>
                                    </div>
                                </div>
                            </div>';
                            if($i == 14) break;
