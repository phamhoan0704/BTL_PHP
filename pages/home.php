            ...
            <div class="home-tabs">
                ...
                <div class="home-tab-content">
                                        ...
                                        <div class="product-block col-5">
                                            <div class="product__img-block">
                                                <div class="product__sale">
                                                    <span class="sale-lable">- ' .$product_best_selling[$i]['product_discount'] . '%</span>
                                                </div>
                                                <div class="product__sold-out-label">HẾT HÀNG</div>
                                                <div class="img">
                                                    <a href="productdetail.php?id='.$product_best_selling[$i]['product_id'].'" class="product__img-link">
                                                        <img src="../img/product/'.$product_best_selling[$i]['product_image'].'" alt="" class="product__img">
                                                    </a>
                                                    <div class="pdt_icon">
                                                        <a class="btn-quickview" href="./productdetail.php?id='.$product_best_selling[$i]['product_id'].'" data-handle="/products/monster-8-2" title="Xem nhanh">
                                                            <i class="icon_list">
                                                        ...
                                                        <a href="./cart.php?id='.$product_best_selling[$i]['product_id'].'" class="btn-buynow" data-max="1000" data-id="1087486242" data-variant="1087486242" title=" Mua ngay ">
                                                            <i class="icon_list">
                                                                <?xml version="1.0" encoding="iso-8859-1"?>
                                                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                        ...
                                                        <a class="btn-add-to-cart ajax_add_to_cart " data-max="1000" data-id="1087486242" data-variant="1087486242" href="./cart.php?id='.$product_best_selling[$i]['product_id'].'" title="Thêm vào giỏ ">
                                                            <i class="icon_list">
                                                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            ...
                                            <div class="product__detail">
                                                <a href="productdetail.php?id='.$product_best_selling[$i]['product_id'].'" class="product__name" title="'.$product_best_selling[$i]['product_name'].'">'.$product_new[$i]['product_name'].'</a>
                                                <div class="product__price">
                                                    <p class="pro-price__new">'.number_format($product_best_selling[$i]['product_price']).'đ</p>
                                                    <p class="pro-price__old">'.number_format($product_best_selling[$i]['product_price_pre']).'đ</p>
                                                </div>
                                            </div>
                                        </div>';
                                        if($i == 14) break;
                    ...
                    <div class="home-tab-pane">
                        ...
                        <div class="product-list">
                            <?php
                                for ($i = 0; $i < count($product_hot_deals); $i++) {
                                    echo '                                  
                                        <div class="product-block col-5">
                                            <div class="product__img-block">
                                                <div class="product__sale">
                                                    <span class="sale-lable">- ' .$product_hot_deals[$i]['product_discount'] . '%</span>
                                                </div>
                                                <div class="product__sold-out-label">HẾT HÀNG</div>
                                                <div class="img">
                                                    <a href="productdetail.php?id='.$product_hot_deals[$i]['product_id'].'" class="product__img-link">
                                                        <img src="../img/product/'.$product_hot_deals[$i]['product_image'].'" alt="" class="product__img">
                                                    </a>
                                                    <div class="pdt_icon">
                                                        <a class="btn-quickview" href="./productdetail.php?id='.$product_hot_deals[$i]['product_id'].'" data-handle="/products/monster-8-2" title="Xem nhanh">
                                                            <i class="icon_list">
                                                                <?xml version="1.0" encoding="iso-8859-1"?>
                                                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                                        viewBox="0 0 511.992 511.992" style="enable-background:new 0 0 511.992 511.992;" xml:space="preserve">
                                                        ...
                                                        <a href="./cart.php?id='.$product_hot_deals[$i]['product_id'].'" class="btn-buynow" data-max="1000" data-id="1087486242" data-variant="1087486242" title=" Mua ngay ">
                                                            <i class="icon_list">
                                                                <?xml version="1.0" encoding="iso-8859-1"?>
                                                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                                    viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                        ...
                                                        <a class="btn-add-to-cart ajax_add_to_cart " data-max="1000" data-id="1087486242" data-variant="1087486242" href="./cart.php?id='.$product_hot_deals[$i]['product_id'].'" title="Thêm vào giỏ ">
                                                            <i class="icon_list">
                                                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                                    width="446.843px" height="446.843px" viewBox="0 0 446.843 446.843" style="enable-background:new 0 0 446.843 446.843;"
                                                                    xml:space="preserve">
                                            ...
                                            <div class="product__detail">
                                                <a href="productdetail.php?id='.$product_hot_deals[$i]['product_id'].'" class="product__name" title="'.$product_hot_deals[$i]['product_name'].'">'.$product_new[$i]['product_name'].'</a>
                                                <div class="product__price">
                                                    <p class="pro-price__new">'.number_format($product_hot_deals[$i]['product_price']).'đ</p>
                                                    <p class="pro-price__old">'.number_format($product_hot_deals[$i]['product_price_pre']).'đ</p>
                                                </div>
                                            </div>
                                        </div>';
                                if($i == 16) break;            
